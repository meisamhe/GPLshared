...
diary off
delete C:\Users\MHE\Desktop\ActiveCourses\ChoiceSeminar\HWs\HW2\ec244ps5\myrun10252013.out
diary C:\Users\MHE\Desktop\ActiveCourses\ChoiceSeminar\HWs\HW2\ec244ps5\myrun10252013.out

% TITLE
% Put a title for the run in the quotes below, to be printed at the top of the output file.
disp 'Mixed logit with 100 random draws: price fixed, others normal.'
...
XMAT=load('C:\Users\MHE\Desktop\ActiveCourses\ChoiceSeminar\HWs\HW2\ec244ps4\data.txt');  %The variables are described below
XMAT(:,4)=XMAT(:,4)./10000;   %To scale price to be in tens of thousands of dollars.
XMAT(:,5)=XMAT(:,5)./10; %To scale operating cost to be in tens of dollars.
XMAT(:,5)= -XMAT(:,5);
XMAT(:,4)= -XMAT(:,4);
