...
def main():
    ...
    filename = "9.ExternalStorage.txt"
    type     = "reviews"
    type = "reviewTitles"
    file = open("C:/Users/MeisamHe/Desktop/Projects/TextMining/CleanedData/%s/%s"%(type,filename), 'r')
    ...
    file = open("C:/Users/MeisamHe/Desktop/Projects/TextMining/CleanedData/wordFreq/%s %s"%(type,filename), "w")
