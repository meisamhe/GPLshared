...
leadershipBoardFilePath = "C:\\Users\\MeisamHe\\Desktop\\Desktop\\Projects\\Gamification\\UserListData\\leadershipBoard.csv"  # to save leadership board
interestingUsersFilePath = "C:\\Users\\MeisamHe\\Desktop\\Desktop\\Projects\\Gamification\\UserListData\\interestingUsers.csv"  # interestingUsers
...
while nextPageExists == True:
	...
	for i in range(1,numPages,1):
		rawPage = urllib2.urlopen(url)	
		readItem = rawPage.read()
		#time.sleep(0.005) # delays for 5 seconds
