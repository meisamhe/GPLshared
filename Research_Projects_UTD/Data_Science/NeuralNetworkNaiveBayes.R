...
#==========================================================
#test Neural Network, with 10 hidden nodes
#==========================================================
#install.packages('neuralnet')
#library("neuralnet")
#nnet function from nnet package
# net.sqrt <- neuralnet(purchase ~ firstCART+firstCLASS+firstDEPARTMENT+ firstHOME+firstOTHER_PAGE+firstSEARCH_RESULTS+firstSKU+firstSKUSET+    
#                         secondCART+secondCLASS+secondDEPARTMENT+secondHOME+secondOTHER_PAGE+secondSEARCH_RESULTS+secondSKU+secondSKUSET+   
#                         thirdCART+thirdCLASS+thirdDEPARTMENT+thirdHOME+thirdOTHER_PAGE+thirdSEARCH_RESULTS+thirdSKU+thirdSKUSET+    
#                         fourthCART+fourthCLASS+fourthDEPARTMENT+fourthHOME+ fourthOTHER_PAGE+fourthSEARCH_RESULTS+fourthSKU+fourthSKUSET+   
#                         fifthCART+ fifthCLASS+fifthDEPARTMENT+fifthHOME+fifthOTHER_PAGE+ fifthSEARCH_RESULTS+fifthSKU+fifthSKUSET+    
...
#                         eighthCART+eighthCLASS+eighthDEPARTMENT+eighthHOME+ eighthOTHER_PAGE+eighthSEARCH_RESULTS+eighthSKU+ eighthSKUSET+   
#                         firstDur+secondDur+ThirdDur+ FourthDur+FifthDur+SixthDur+SeventhDur+EighthDur+account+cart+classProd+department+     
#                         home+other_page+search_results+sku+skuset,TSet, hidden=3, threshold=0.01)
# net.results <- compute(net.sqrt, VSet) #Run them through the neural network
#Lets see the results
# print(net.results$net.result)
#install.packages('nnet')
library(nnet)
mod1<-nnet(TSet[,-82],TSet[,82],size=10)
predictionResult = predict(mod1, VSet[,-82])
...
accuracy = (TP+TN)/(TP+TN+FP+FN)  #0.7359759026
recall = TP/(TP+FN)               #0.3194306521
precision = TP/(TP+TN)            #0.1144789133

#==========================================================
#test Neural Network, with 5 hidden nodes
#==========================================================
library(nnet)
mod1<-nnet(TSet[,-82],TSet[,82],size=5,rang = 0.1,
...
#less accurate, but high recall and precision than ada-boost
accuracy = (TP+TN)/(TP+TN+FP+FN)  #0.7362378312 (more than before)
recall = TP/(TP+FN)               #0
precision = TP/(TP+TN)            #0

#==========================================================
#test Neural Network, with 15 hidden nodes
#==========================================================
#mlp function from RSNNS package: multilayered perceptron
#install.packages("RSNNS")
library(RSNNS)
mod1<-mlp(TSet[,-82],TSet[,82], size=15)
...
#less accurate, but high recall and precision than ada-boost
accuracy = (TP+TN)/(TP+TN+FP+FN)  #0.736281486 (more than before)
recall = TP/(TP+FN)               #0.0001655081099
precision = TP/(TP+TN)            #0.00005929088106

#==========================================================
#test Neural Network, with 30 hidden nodes, with 500 iterations to fit more
#==========================================================
#mlp function from RSNNS package: multilayered perceptron
#install.packages("RSNNS")
library(RSNNS)
mod1<-mlp(TSet[,-82],TSet[,82], size=30,maxit=500)
...
#less accurate, but high recall and precision than ada-boost
accuracy = (TP+TN)/(TP+TN+FP+FN)  #0.73156677 (more than before)
recall = TP/(TP+FN)               #0.5393909302
precision = TP/(TP+TN)            #0.1944742809

#==========================================================
#test Neural Network, with 50 hidden nodes, with 500 iterations to fit more
#==========================================================
#mlp function from RSNNS package: multilayered perceptron
#install.packages("RSNNS")
library(RSNNS)
mod1<-mlp(TSet[,-82],TSet[,82], size=50,maxit=500)
...
#==========================================================
#test Neural Network, with 75 hidden nodes, with 500 iterations to fit more
#==========================================================
#mlp function from RSNNS package: multilayered perceptron
#install.packages("RSNNS")
library(RSNNS)
mod1<-mlp(TSet[,-82],TSet[,82], size=75,maxit=500)
...
precision = TP/(TP+TN)            #0
#==========================================================
#test Neural Network, with 30 hidden nodes, with 700 iterations to fit more
#==========================================================
#mlp function from RSNNS package: multilayered perceptron
#install.packages("RSNNS")
library(RSNNS)
mod1<-mlp(TSet[,-82],TSet[,82], size=30,maxit=700)
