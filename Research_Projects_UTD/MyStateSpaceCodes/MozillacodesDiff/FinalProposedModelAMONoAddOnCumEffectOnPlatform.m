...
while ((alpha < accptnrnd)) %&& (swfac == 1) )
   ...
   postPNew  = -PlatformFullLikelihoodNoAddOn(pqM0betaNew,yc,ttind1p,ttr1,[m0p mp(:,1:pT-1)]',wp,S0p,b0p,caddon); % log of new posterior
   postPOld  = -PlatformFullLikelihoodNoAddOn(pqM0beta,yc,ttind1p,ttr1,[m0p mp(:,1:pT-1)]',wp,S0p,b0p,caddon); % log of old posterior
