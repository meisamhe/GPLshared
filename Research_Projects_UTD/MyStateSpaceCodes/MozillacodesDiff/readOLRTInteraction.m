function  [x,y,uT,ol,stvar,ver,wkend,status,Ti,stol,stavg] = readOLRTInteraction(num,Ti,alphabeta,p,tt1p,tt0p,pT,scale,pusg,ffxvrsn,numCatOL,numCatVAR,i) %,b1,b2,alpha %,int ,piai
