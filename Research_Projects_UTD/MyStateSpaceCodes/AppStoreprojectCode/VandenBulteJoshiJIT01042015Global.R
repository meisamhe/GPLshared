...
StateSpaceJoshiVanDenBulte12282014func=
  function(logfilename,categoryDiffData,CategoryHBData){
    ...
    return(list(thetacatjdraw=thetacatjdraw,ccat_=ccat_,Y1cat_=Y1cat_,categoryDiffWeekly=categoryDiffWeekly,
                Deltadrawthetacatj=Deltadrawthetacatj,
                bcat_=bcat_,probdrawthetacatj=probdrawthetacatj,llcat_=llcat_,MADcat_=MADcat_,
                MADcat_=MSEcat_
                ,compdrawthetacatj=compdrawthetacatj))
  }
...
# #============================================================================
sink()
thetacatjdraw=resultOfFiltering[[1]]
ccat_=resultOfFiltering[[2]]
Y1cat_=resultOfFiltering[[3]]
categoryDiffWeekly=resultOfFiltering[[4]]
Deltadrawthetacatj=resultOfFiltering[[5]]
bcat_=resultOfFiltering[[6]]
probdrawthetacatj=resultOfFiltering[[7]]
llcat_=resultOfFiltering[[8]]
MADcat_=resultOfFiltering[[9]]
MADcat_=resultOfFiltering[[10]]
compdrawthetacatj=resultOfFiltering[[11]]

# #Check convergance plots (diffusion parameters of Van den Bulte and Joshi)
plot(thetacatjdraw[2,4,])  # dim: 10 x 8 x 5000
                           # 10 categories 
                           #thetacatjest[1:7] = (p1,p2,q1,q2,N(influentials),N(immit),w)
                           # [8]: exp(thresholds)/(1+exp(thresholds)))

# test confidence interval
#thetacatj (the diffusion parameters of the VandenBulte and Joshi)
...
#==========================================================================
# Check actual versus step ahead 
#==========================================================================
#actual data
ncat = 10
T  = 258
