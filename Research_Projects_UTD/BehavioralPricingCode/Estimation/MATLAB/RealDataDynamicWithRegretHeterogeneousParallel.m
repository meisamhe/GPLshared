...
FitnessFunction = {@FuncDatanBLPWithRegEffcntParallelDyn,P1,P2,Dur1,Dur2,lambda,gamma,shares,km,cost};
numberOfVariables = 4;
...
% fval =  -300.1371
% calculating hessian:
f = @(x)FuncDatanBLPWithRegEffcntParallelDyn(x,P1,P2,Dur1,Dur2,lambda,gamma,shares,km,cost);
...
hessian =hess;
x =    [-1.5241    1.6049   -0.1975    4.3871];
FuncDatanBLPWithRegEffcntParallelDyn(x,P1,P2,Dur1,Dur2,lambda,gamma,shares,km,cost)
fval =  -300.1371;
p       =  5;
betas   =  betas';
se_est  =  se_est';
