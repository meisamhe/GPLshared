...
% Not parallel version with full model (d1c+d2c-bpP1)
...
global deltatemp deltatemp cbp cbphess
global variance
...
[x,fval,exitflag,output,grad,hessian]=fminunc('FuncDatanBLPWithRegEffcntFullMDL',X0,options,P1,P2,Dur1,Dur2,lambda,gamma,shares,km,cost);
toc;
x = [-1.5303    1.6049   -0.1975    4.3871]; % optimum found
FuncDatanBLPWithRegEffcntFullMDL(x,P1,P2,Dur1,Dur2,lambda,gamma,shares,km,cost) % put in order to find real value of betas
...
FitnessFunction = {@FuncDatanBLPWithRegEffcntFullMDL,P1,P2,Dur1,Dur2,lambda,gamma,shares,km,cost};
numberOfVariables = 4;
...
% fval =  -300.1371
% calculating hessian:
f = @(x)FuncDatanBLPWithRegEffcntFullMDL(x,P1,P2,Dur1,Dur2,lambda,gamma,shares,km,cost);
...
hessian =hess;
x =    [-1.5241    1.6049   -0.1975    4.3871];
FuncDatanBLPWithRegEffcntParallelFullMDL(x,P1,P2,Dur1,Dur2,lambda,gamma,shares,km,cost)
fval =  -300.1371;
p       =  5;
betas   =  betas';
se_est  =  se_est';
