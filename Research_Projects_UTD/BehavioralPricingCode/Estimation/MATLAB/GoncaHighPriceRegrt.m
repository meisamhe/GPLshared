% modified code only high price regret
clear all; 
...
%beta=[alpha c bp];
X1= [ones(J,1) (1+gamma)*ones(J,1) P1 lambda.*(P1-P2)];
X2= [gamma*lambda gamma*lambda gamma*lambda.*P2 zeros(J,1)];
