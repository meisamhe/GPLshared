...
[x,fval,exitflag,output,grad,hessian]=fminunc('FuncIdentificationBLPWithRegEffcntParallel',X0,options,P1,P2,Dur1,Dur2,lambda,gamma,shares,km,cost,pi1r,bpdr,alphapdr,betardr,cr);
...
FitnessFunction = @FuncIdentificationBLPWithRegEffcntParallel;
numberOfVariables = 4;
