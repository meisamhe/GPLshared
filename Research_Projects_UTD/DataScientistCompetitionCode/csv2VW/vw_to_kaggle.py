...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>kaggle-criteo/vw_to_kaggle.py at master · MLWave/kaggle-criteo</title>
...
<meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="https://avatars3.githubusercontent.com/u/6892725?v=3&amp;s=400" property="og:image" /><meta content="MLWave/kaggle-criteo" property="og:title" /><meta content="https://github.com/MLWave/kaggle-criteo" property="og:url" /><meta content="kaggle-criteo - Kaggle Criteo https://www.kaggle.com/c/criteo-display-ad-challenge" property="og:description" />
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="4CB8F51B:1D6B:C3CC6A6:54C7CFB9" name="octolytics-dimension-request_id" /><meta content="10239780" name="octolytics-actor-id" /><meta content="meisamhe" name="octolytics-actor-login" /><meta content="6eaa769126be4e80b8ab7bc48e8e065c586385e8b9a05056fb23bbf4a69c195e" name="octolytics-actor-hash" />
...
<meta content="lhP3/2lrWkaFYamMITqbnecc320aDonTk+8O1nHlRksDZpzy9D7NOe8xrIXBYY8nk7GXuKlDZPbkgrpTXvC3Gg==" name="csrf-token" />
...
<ul class="dropdown-menu">
  ...
  <li class="header-nav-item">
    <form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="s1VKiiXatDyJprSGEOjSZdYrFqOIo87ooQt/Pk6JSfYSYR7mI1f5VlTjKtLe6CiqWnH9Fl88QtYAa/hAqVe4eA==" /></div>
...
<ul class="pagehead-actions">
    ...
    <li class="subscription">
      <form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="kaBFpC76sdSMA+4Rgui2zq6IzCd9fSG95fAh1Y7SMY0lCOtCGhlmQkwJkOwDx6Tn+Sm8gj7d5KjFyOBJ3DNSGw==" /></div>  <input id="repository_id" name="repository_id" type="hidden" value="21262985" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    ...
    <form accept-charset="UTF-8" action="/MLWave/kaggle-criteo/unstar" class="js-toggler-form starred js-unstar-button" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="yg/8SuoG2XS0AW1NEuQiZj3KITQUpIkqpeQZLcnqxfjoWIUo5CU3GWQADoYeT2KbmdZWb9rHnpaft4EiKjpGQw==" /></div>
      <button
    ...
    <form accept-charset="UTF-8" action="/MLWave/kaggle-criteo/star" class="js-toggler-form unstarred js-star-button" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="J+XEu8D0e16sT2KmqfIfnRUFbiOn66+iD5ygkU6mKYBScc3dAG9oj7s4+x4AwV3FJgcvdStfsYYTVLvfctRwmg==" /></div>
      <button
        class="minibutton with-count js-toggler-target star-button"
...
<a href="/MLWave/kaggle-criteo/blob/35a7dea52a5aff278819d875c6dd4c300911890d/vw_to_kaggle.py" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:0d8a59c740abb8d8d94e163d6c5e7784 -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/MLWave/kaggle-criteo/blob/master/vw_to_kaggle.py"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
...
<div class="file-box">
    ...
    <div class="meta clearfix">
      ...
      <div class="actions">
        <div class="button-group">
          <a href="/MLWave/kaggle-criteo/raw/master/vw_to_kaggle.py" class="minibutton " id="raw-url">Raw</a>
            <a href="/MLWave/kaggle-criteo/blame/master/vw_to_kaggle.py" class="minibutton js-update-url-with-hash">Blame</a>
          <a href="/MLWave/kaggle-criteo/commits/master/vw_to_kaggle.py" class="minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
          ...
          <a class="octicon-button tooltipped tooltipped-nw"
             href="http://windows.github.com" aria-label="Open this file in GitHub for Windows">
              ...
              <a class="octicon-button tooltipped tooltipped-n js-update-url-with-hash"
                 ...
                 href="/MLWave/kaggle-criteo/edit/master/vw_to_kaggle.py"
                 data-method="post" rel="nofollow"><span class="octicon octicon-pencil"></span></a>

            <a class="octicon-button danger tooltipped tooltipped-s"
               href="/MLWave/kaggle-criteo/delete/master/vw_to_kaggle.py"
  ...
  <div class="blob-wrapper data type-python">
      ...
      <tr>
        ...
        <td id="LC1" class="blob-code js-file-line"><span class="pl-k">import</span> math</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC3" class="blob-code js-file-line"><span class="pl-st">def</span> <span class="pl-en">zygmoid</span>(<span class="pl-vpf">x</span>):</td>
      </tr>
      <tr>
        <td id="L4" class="blob-num js-line-number" data-line-number="4"></td>
        <td id="LC4" class="blob-code js-file-line">	<span class="pl-c">#I know it&#39;s a common Sigmoid feature, but that&#39;s why I probably found</span></td>
      </tr>
      <tr>
        <td id="L5" class="blob-num js-line-number" data-line-number="5"></td>
        <td id="LC5" class="blob-code js-file-line">	<span class="pl-c">#it on FastML too: https://github.com/zygmuntz/kaggle-stackoverflow/blob/master/sigmoid_mc.py</span></td>
      </tr>
      <tr>
        <td id="L6" class="blob-num js-line-number" data-line-number="6"></td>
        <td id="LC6" class="blob-code js-file-line">	<span class="pl-k">return</span> <span class="pl-c1">1</span> <span class="pl-k">/</span> (<span class="pl-c1">1</span> <span class="pl-k">+</span> math.exp(<span class="pl-k">-</span>x))</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC8" class="blob-code js-file-line"><span class="pl-k">with</span> <span class="pl-s3">open</span>(<span class="pl-s1"><span class="pl-pds">&quot;</span>kaggle.click.submission.csv<span class="pl-pds">&quot;</span></span>,<span class="pl-s1"><span class="pl-pds">&quot;</span>wb<span class="pl-pds">&quot;</span></span>) <span class="pl-k">as</span> outfile:</td>
      </tr>
      <tr>
        <td id="L9" class="blob-num js-line-number" data-line-number="9"></td>
        <td id="LC9" class="blob-code js-file-line">	outfile.write(<span class="pl-s1"><span class="pl-pds">&quot;</span>Id,Predicted<span class="pl-cce">\n</span><span class="pl-pds">&quot;</span></span>)</td>
      </tr>
      <tr>
        <td id="L10" class="blob-num js-line-number" data-line-number="10"></td>
        <td id="LC10" class="blob-code js-file-line">	<span class="pl-k">for</span> line <span class="pl-k">in</span> <span class="pl-s3">open</span>(<span class="pl-s1"><span class="pl-pds">&quot;</span>c:<span class="pl-cce">\\</span>click.preds.txt<span class="pl-pds">&quot;</span></span>):</td>
      </tr>
      <tr>
        <td id="L11" class="blob-num js-line-number" data-line-number="11"></td>
        <td id="LC11" class="blob-code js-file-line">		row <span class="pl-k">=</span> line.strip().split(<span class="pl-s1"><span class="pl-pds">&quot;</span> <span class="pl-pds">&quot;</span></span>)</td>
      </tr>
      <tr>
        <td id="L12" class="blob-num js-line-number" data-line-number="12"></td>
        <td id="LC12" class="blob-code js-file-line">		outfile.write(<span class="pl-s1"><span class="pl-pds">&quot;</span><span class="pl-c1">%s</span>,<span class="pl-c1">%f</span><span class="pl-cce">\n</span><span class="pl-pds">&quot;</span></span><span class="pl-k">%</span>(row[<span class="pl-c1">1</span>],zygmoid(<span class="pl-s3">float</span>(row[<span class="pl-c1">0</span>]))))</td>
      </tr>
      <tr>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.04438s from github-fe136-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
