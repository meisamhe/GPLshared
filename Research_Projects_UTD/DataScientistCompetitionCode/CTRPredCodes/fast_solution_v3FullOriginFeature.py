...
submission = "C:\\Users\\mxh109420\\Desktop\\KaggleCometition\\submission1234FullFeatureMoreIter.csv"  # path of to be outputted submission file
...
# 2**200 takes so much time, so I decided to iterate at least 10 times on the online grad descent

D = 2 ** 13         # number of weights to use
niter = 10
...
counterTest = 0
yCounterTest = 0
for e in range(1,niter,1):#xrange(epoch):
    loss = 0.
    count = 0
