...
#==========================================
# check for ten passes (iterate over the data set 10 times)
# -c creates a creates a binary cache of dataset for faster loading next time
#============================================
# logistic
.\vowelWabbit\vw.exe -d .\vwtrain1.data -c --passes 10 -f .\predictor.vw --loss_function logistic --l2 0.1 --l1 0.1
.\vowelWabbit\vw.exe -d .\vwttest.data -t -i .\predictor.vw -p .\predictions.out

# svm
.\vowelWabbit\vw.exe -d .\vwtrain.data -c --passes 10 -f .\predictorSVM.vw --loss_function hinge --l2 0.1 --l1 0.1
.\vowelWabbit\vw.exe -d .\vwttest.data -t -i .\predictorSVM.vw -p .\predictionsSVM.out

#=================================================
# Next try: put interaction in the dummy data and test
#=================================================
#didn't work
...
#==============================================
# Next try: 
#(1) build the dummy variable on data and only then send to vowpel wabbit
#(2) also increase the size of hash by -b
#(3) set the regularization to 1
#=================================================


#===========================================
# next I can use adaptive system for learning rate
# --adaptive -l 1
#================================================
...
#===============================================
# Next try: Error Correcting Tournament /Filter Tree
