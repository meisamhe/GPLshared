...
function [y] = HorskeySimonMethodM0EKF(x,yc,ppparam,npparam,qpparam,ttind1p,ttr1,Lpriorp,m)
...
LL =    - 0.5*size(ttind1p,1)*log(2*pi*variance) -   0.5*sum(errors.^2/variance);
