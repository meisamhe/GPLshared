    ...
    public void jButtonSearch_actionPerformed(ActionEvent e) {
    	...
    	try{
    		...
    		if(threshold>=1 || threshold<0){
    			JOptionPane.showMessageDialog(null,"Threshold must be a number between 0 and 1!","Wrong Threshold",JOptionPane.ERROR_MESSAGE);
    			return;
    		}
    	}
    	catch(Exception exp){
    	...
    	if(queryFile==null){
    		JOptionPane.showMessageDialog(null,"You must first select the query file using brows button!!!","Error : no query file",JOptionPane.ERROR_MESSAGE);
    		return;
    	}
