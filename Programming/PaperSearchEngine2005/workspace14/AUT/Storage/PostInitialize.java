...
public class PostInitialize {
	...
	private void init() {
		int docNum=Integer.parseInt(io.readFileAsString(new File(path+"docnum.txt"),1));
		buildDocDocMatrix(1,docNum,io.createFile(path+docdoc+".txt"));
		...
		while(flag== true){
			...
			first= end;//dafe bad bayad az onsor badi bekhoone
