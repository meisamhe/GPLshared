...
--&gt;
</style></head><body alink="#00563b" bgcolor="#eeeeee" link="#00a651" text="#999999" vlink="#00563b">
  <!-- HEADER //-->
<a name="top"></a>
...
if (theForm.email.value == "")
{
            ...
            <tr>
              ...
              <td colspan="2" valign="top">
                ...
                <br>
                      ...
                      <input name="key" value="" class="lhstext126" size="12" type="text" style="width: 115px">
                    	</form>
              </td>
              <td>              </td>
            </tr>
  ...
  <%
    ...
    try {
      ...
      String sender = (String) (request.getParameter("firstname"));
      System.out.println(sender);
      emailclient.from(sender);
