<%@page import="sun.net.smtp.SmtpClient, java.io.* ,java.*,jdbcMySql.*, java.sql.Connection,java.lang.*"%>
<html>
<head>
...
try{
  ...
  Connection con = us.getDbConnection("mani", "mbh", "3306", "localhost", "3m");
  Users use = new Users(con);
  java.util.Date date = new java.util.Date();
  char ch;
  if (request.getParameter("p_gender").equals("m"))
  ch = 'm';
  else
  ch = 'f';
 if (request.getParameter("p_password").equals(request.getParameter("p_password2"))) {
    String name = request.getParameter("p_name");
    System.out.println(name);
    String lastname = request.getParameter("p_l_name");
    System.out.println(lastname);
    String username = request.getParameter("p_user_name");
    System.out.print(username);
    String password = request.getParameter("p_password");
    System.out.println(password);
    Double deposit = new Double(request.getParameter("p_deposit"));
    System.out.print(request.getParameter("p_deposit"));
    ...
    use.insert(name, lastname, username, password, deposit.doubleValue(), email,
    ch, address, tel, 'N', description,
    "2007-02-10", "2007-03-10", "2007-02-10", 1);
  ...
  if (theForm.email.value.indexOf(".",theForm.email.value.indexOf("@")+1) == -1)
  {
	...
	//-->
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="144">
          <tbody>
            <tr>
              <td valign="top" width="9" style="height: 18px">
                <img src="Template2_MMM.com_files/gap.gif" alt="" border="0" height="1" width="9">
              </td>
              <td colspan="2" valign="top" width="126" style="height: 18px">
                <img src="Template2_MMM.com_files/gap.gif" alt="" border="0" height="18" width="1">
                                <img src="Template2_MMM.com_files/left_search.gif" alt="Search" border="0" height="17" width="47"></td>
              <td valign="top" width="9" style="height: 18px">
                <img src="Template2_MMM.com_files/gap.gif" alt="" border="0" height="1" width="9">
              </td>
            </tr>
      ...
      <td valign="top" width="625">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td align="center" bgcolor="#ffffff" valign="top" width="100%">
                        <a href="http://www.mmm.com.au/products/harrypotter.asp">
        ...
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <%System.out.println(request.getParameter("p_password"));
        System.out.println(request.getParameter("p_password2"));%>
      <%if (request.getParameter("p_password").equals(request.getParameter("p_password2"))) {      %>
        <p align="center">
          <img src="Thanks_file/20050905154215609.jpg" width="180" height="180" alt="">
        </p>
        <p align="center">
          <img src="thank you/LL030320Thank20You.gif" width="268" height="109" alt="">
        </p>
        <p align="center" class="titlebig style3">Thank you for registeration.You have registered successfully.</p>
      <%
        String emailFrom = "confirmer@localhost";
        try {
          SmtpClient emailclient = new SmtpClient("localhost");
          emailclient.to((String) request.getParameter("p_email"));
          emailclient.from(emailFrom);
          PrintStream msg = emailclient.startMessage();
          msg.println("Subject:" + "registeration confirmation" + request.getParameter("p_name") +
                      request.getParameter("p_l_name"));
          msg.println("To: " + request.getParameter("p_email"));
          msg.println("you have registered mmm.com");
      ...
      %>
      <%} else {      %>
        <p align="center" class="titlebig style3">Sorry your pass word does not match!</p>
