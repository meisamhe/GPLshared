          ...
          <table border="0" cellpadding="0" cellspacing="0" width="144">
            <tbody>
              ...
              <tr>
                <td>                </td>
                <td class="style7">                
                    	<input name="Submit13" type="submit" value="Search"></td>
              </tr>
              <tr>
                <td colspan="4">
            ...
            <tbody>
              ...
              <tr bgcolor="#cccccc">
                ...
                <td bgcolor="#ffffff" valign="top" width="264">
                  <table border="0" cellpadding="0" cellspacing="9" width="376">
                    <tbody>
                      <tr>
                        <td width="358" height="27" valign="top" bgcolor="#00563b">
                          <span class="style3">Welcom </span>
                        </td>
                      </tr>
                    </tbody>
                  </table>
                ...
                <td width="356" valign="top" bgcolor="#00563b">
              ...
              <tr bgcolor="#cccccc">
                ...
                <td bgcolor="#ffffff" valign="top">
                  ...
                  <p>
                  <p>
                    <span style="font-size:large">Welcome to mmm.com e-store you can reach
books, cd and stationaries just by one click. After seeing your favorite merchandize just after eye blick by click
it will be added to your cart.</span>
                  </p>
                  <p>                  </p>
                  <p>                  </p>
                  <p>
                    <span style="font-size:x-large"> if you are not registered
dont worry you can sign up easier than anywhere just by one click here</span>

                  <p>
                  <form action="Signup.jsp" method="POST">
                  <P align="center">
                    <input name="Submit12" type="submit" value="SignUp" style="width:160px; height:43px; background-color:#3399FF; border-bottom-color:#00FFFF"/>
                  </p>
                  </form>
                </td>
                <td valign="top">
