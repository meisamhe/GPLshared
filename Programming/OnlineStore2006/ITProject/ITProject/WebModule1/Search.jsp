...
<tr bgcolor="#cccccc">
<td valign="top" width="1"><img src="Template2_MMM.com_files/gap.gif" alt="" border="0" height="1" width="1"></td>
<td bgcolor="#ffffff" valign="top" width="6"><span class="style4"></span></td>
<td valign="top" width="1"><img src="Template2_MMM.com_files/gap.gif" alt="" width="1" height="1" border="0"></td>
<td bgcolor="#ffffff" valign="top" width="616"><p class="style5">      Please insert your query
    </p>
    <form action="Search.jsp" method="get" class="style4">
