	...
	//-->
      ...
      <td valign="top" width="625">
        ...
        <div id="contents">
          ...
          <p class="style4">
            MMM e-store is committed to providing you with the best shopping
            experience possible.
          ...
          <table border="0" cellpadding="0" cellspacing="10" width="400">
            <tbody>
              <tr>
                <td class="titleText">
                  <span class="style4">First Name: *</span>
                  <br>
                  <input value="" style="width: 185px;" size="19" name="firstname" type="text">
                </td>
                <td class="titleText">
                  <span class="style4">Last Name: *</span>
                  <br>
                  <input value="" style="width: 185px;" size="20" name="lastname" type="text">
                </td>
              </tr>
              <tr>
                <td colspan="2" class="titleText">
                  ...
                  <br>
                  <input value="" style="width: 380px;" size="44" name="sender" type="text">
                </td>
              </tr>
              <tr>
                <td colspan="2" class="titleText">
                  <span class="style4">I need help with *</span>
                  <br>
                  <span class="select"> <!-- *** this line is used to make the pull-down look in NS similar to EI *** --> <select style="width: 380px;" name="subject"><option value="">Choose One </option><option value="Product Information">Product Information </option><option value="Order Information">Order Information &amp; Returns  </option><option value="Registration &amp; Password Inquiries">Registration &amp; Password Inquiries </option><option value="Website Feedback, Complaints">Website Feedback, Complaints </option><option value="Technical Issues">Technical Issues </option><option value="Retail Store Information">Retail Store Information </option><option value="General Issues">General Issues </option></select></span>
                  <!-- *** this line is used to make the pull-down look in NS similar to EI *** -->
                </td>
              </tr>
              <tr>
                <td colspan="2" class="titleText">
                  <span class="style4">Comments *</span>
                  <br>
                  <textarea cols="31" rows="6" style="width: 380px;" name="body">                  </textarea>
                </td>
              </tr>
              <tr>
                <td>
                  <span class="style4">* Required Fields</span>
                </td>
                <td align="right">
                  <input src="Contactus_file/btn_submit.gif" name="sendEmail" type="image">
                </td>
              </tr>
            </tbody>
          </table>
          <p class="style4">For other general inquiries to The MMM e-store, please contact us using the appropriate email below.</p>
          <p>
            <span class="style4">Our director</span>
            <br>
            <a href="mailto:meisam.hejazynia@gmail.com">meisam.hejazynia@gmail.com</a>
          </p>
          <p>
            <span class="style4">Our sales manager</span>
            <br>
            <a href="mailto:mani.hosseini@gmail.com">mani.hosseini@gmail.com</a>
          </p>
          <p>
            <span class="style4">Our technical manager</span>
            <br>
            <a href="mailto:keyvanrad_ma@yahoo.com">keyvanrad_ma@yahoo.com</a>
          </p>
          </form>
        </div>
        <p align="center" class="titlebig style3">&nbsp;</p>
        <p align="center" class="titlebig style3">&nbsp;</p>
        <p align="center" class="titlebig style3">&nbsp;</p>
      </td>
    </tr>
