...
public class Users {
     ...
     */
    public int insert(String name, String l_name, String userName,
                         String password, double deposit, String email,
                         char gender,
                         String address, String tel, char isactive,
                         String description,
                         String createdDate, String expirationDate,
                         String modifiedDate, int type) {
        String sql = "INSERT INTO USERS VALUES (NULL,'" + name + "','" + l_name +
                     "','" + userName + "','" + password;
        sql += "','" + deposit + "','" + email + "','" + gender + "','" +
                address + "','" + tel + "','" + isactive + "','" + description;
        sql += "','" + createdDate + "','" + expirationDate + "','" +
                modifiedDate + "','" + type + "')";
