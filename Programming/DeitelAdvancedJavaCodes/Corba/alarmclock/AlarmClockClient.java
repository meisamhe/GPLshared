...
public class AlarmClockClient extends _AlarmListenerImplBase {
   ...
   public AlarmClockClient( String params[] ) throws Exception
   {
      ...
      name = new Long(System.currentTimeMillis() % 10000 ).toString();
   ...
   private void connectToAlarmServer(String name, String params[] )
      ...
      NotFound, CannotProceed
   {
      ...
      // connect to Naming Service and find object reference for AlarmClock service
      ...
      NameComponent nameComponent =  new NameComponent( AlarmClock.NAME, "" );
      NameComponent path[] = { nameComponent };
      alarmClock = AlarmClockHelper.narrow( naming.resolve( path ) );
   ...
   public void updateTime(long seconds)
   {
      ...
      gui.setText("Alarme " + name + " vem em " + seconds
         + " segundos. Resetando para " + newTime + " segundos " );
   ...
   public static void main( String args[] ) throws Exception
   {
      ...
      // process exceptions that occur while client executes
         ...
         System.out.println("Exception thrown by AlarmClockClient:" );
