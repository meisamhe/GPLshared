...
public class DisplayQueryResults extends JFrame {
   ...
   {   
      ...
      // Firebird database driver class name
      String driver = "org.firebirdsql.jdbc.FBDriver";
     
      // URL to connect to books database
      String url = "jdbc:firebirdsql://150.162.60.54//home/databases/bookdb.fdb";
      
      // login para o BD
      String login = "aluno_cd";
      
      // senha para o BD
      String passwd = "aluno_pw";
      ...
      try {
         ...
         // SELECT * FROM authors
         tableModel = 
            new ResultSetTableModel( driver, url, login, passwd, query );
