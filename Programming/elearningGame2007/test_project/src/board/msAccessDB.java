        ...
        try {
            ...
            if (counter < 32) {
                JOptionPane.showMessageDialog(null,
                                              "Please first import words.The game is out of new word!\n " +
                                              "After Improting please reset game!!",
    ...
    void updateCounter() { // for each time loading the buffer or main board this function will be called
        ...
        try {
            ...
            for (; rst.next(); ) { // for updating Counter
                int tempCounter = Integer.parseInt(rst.getString(1));
                if (tempCounter < 15) {
            ...
            try {
                ...
                if (rst.next()) {
                    ...
                    if (leitnerLevel == 5) {
                        ...
                        s = "UPDATE WordLearning SET Counter =" + 0 +
                            ", LeitnerLevel=" + (++leitnerLevel) + " WHERE " +
                            " [Word]='" + Word + "' AND" + " [Meaning]= '" +
                            Meaning +
                            "'";
                    }
