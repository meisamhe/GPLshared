...
<DIV id=mainContentBorder align=center  style="width:1174px; height:530px">
...
<DIV id=mainContent style="width:1099px; height:408px">
  <DIV id=mainContentMiddleBorder style="width:1052px; height:356px">
<DIV id=mainBody>
<%try{%>
  ...
  <TR vAlign=top>
    <TD 
      ...
      <DIV style="MARGIN: 15px 0px">
        <p>	</p>
		  <% if (true){%>
		<p><span class="affHeadline style7">Activities That are Completed Today 
		(We recommend new assignment):</span> </p>
      </DIV>
	  <table width="815" height="87" border=1 cellpadding=3 cellspacing=0 class="sortable"  id=sections >
        <tbody>
          <tr bgcolor="#999999" class="affHeadline">
            ...
            <td width="58"  align="LEFT" bgcolor="#FFFF99">AssignedTo</td>
...
java.util.Date date = new java.util.Date();
 ...
 String type_164id=  (String)session.getAttribute("TYPE");
        ...
        String date_166id=  date_102id;
        long date_166idTemp  = Long.parseLong(date_166id);
        com.actionTracking.Activity[] completedActivityTodaySubsidary577mtemp = sampleMainServiceProxyid.completedActivityTodaySubsidary(type_164idTemp,user_165idTemp,date_166idTemp);
java.util.List listreturnp279=null;
if(completedActivityTodaySubsidary577mtemp == null){

}else{
     listreturnp279= java.util.Arrays.asList(completedActivityTodaySubsidary577mtemp);
        ...
        %>
                <div align="center">
                  <form method="post" action="Description.jsp" target="_blank">
                    ...
                    <input type="image" name=popcal0 width="36" height="24"  src="discription.gif" border="0" >&nbsp;&nbsp;
                  </form>
                </div>
              <%}%>
                <div id="div<%=i%>"> </div></td>
