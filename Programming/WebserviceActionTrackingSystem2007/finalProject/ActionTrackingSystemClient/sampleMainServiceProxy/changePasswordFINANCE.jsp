...
<DIV id=mainContentBorder align=center style="width: 372px; height: 397px">
 <table width="359">
    <tbody>
      <tr>
        <td width="39">&nbsp;</td>
        <td width="310"><div align="right"><a href="ActionTrackingSystem.jsp"><img src="logout.gif"></a></div></td>
      </tr>
    </tbody>
  </table>
<DIV 
...
src="ActionTrackingSystem_files/spacer.gif" width=295 border=0></DIV>
<div>
<DIV id=mainContent style="width: 366px; height: 330px">
...
<TABLE style="WIDTH: 288px" cellSpacing=0 cellPadding=0 border=0>
  ...
  <TR vAlign=top>
    <TD id=leftContent><!-- ########### LEFT CONTENT ################# -->
      <span class="style2">changePassword</span>
      <FORM name=departmentCreationForm
      action="finance.jsp" method=post onSubmit="return checkPw(this)">
      ...
      <TABLE cellSpacing=0 cellPadding=0 border=0>
        ...
        <TR>
          <TD class="style2">oldPassword</TD>
          <TD><input type=password name=oldPassword width=40 >
          </TD>
        </TR>
        <TR>
          <TD class="style2">newPassword</TD>
          <TD><input type=password name=password width=40 >          </TD>
        </TR>
        <TR>
          <TD class="style2"><p>newPassword</p></TD>
      ...
      </DIV><input type="text" style="visibility:hidden" value="changePassword" name="requestType">
...
<p align="left">
<form action="<%=request.getParameter("FROM")%>" >
<input type='image' src="back.gif" alt="s" width="24" height="24" onClick="finance.jsp">
