...
<TABLE style="WIDTH: 288px" cellSpacing=0 cellPadding=0 border=0>
  ...
  <TR vAlign=top>
    <TD id=leftContent><!-- ########### LEFT CONTENT ################# -->
      <span class="style2">Define New Resource      </span>
...
e.printStackTrace();
        ...
        <TR>
          <TD class="style2">Place</TD>
          <TD><INPUT type=text name=place></TD>
        </TR>
        <TR>
          <TD class="style2">InHand</TD>
      ...
      </DIV><input type="text" style="visibility:hidden" value="newResource" name="requestType">
