...
<DIV id=mainContentBorder align=center style="width: 718px; height: 666px">
<DIV id=mainnavLrg>
</DIV>
<DIV 
...
<DIV id=mainContent style="width: 587px; height: 747px">
<DIV id=breadCrumb style="MARGIN-TOP: 8px;width: 513px; height:19px">
...
<DIV id=mainContentMiddleBorder style="width:587px; height:530px">
<DIV id=mainBody style="width:489px; height:506px">
<!-- THIS PART IS FOR LINE-->
<TABLE style="WIDTH: 308px" cellSpacing=0 cellPadding=0 border=0>
  <TBODY>
  <TR vAlign=top>
    <TD id=leftContent><!-- ########### LEFT CONTENT ################# -->
      <span class="style2">Define Activity </span>
      <FORM name=ActivityCreationForm
      action=managerResponse.jsp method=post onSubmit="return checkPw(this)">
	  
      <DIV class=outlineBox id=signinBox 
      style="MARGIN-TOP: 15px; TEXT-ALIGN: center;width:461px; height:345px" >
      <TABLE width="347" height="217" border=0 cellPadding=0 cellSpacing=0>
        ...
        <TR>
          ...
          <TD width="221" style="COLOR: #2a3960; PADDING-TOP: 0px"></TD></TR>
        <TR>
        ...
        <tr>
          ...
          <TD>
		 <input type="text" name="deadline" size="20" Value="">
<a href="javascript:void(0)" onclick="showCal('calFirstDate');" HIDEFOCUS>
<img src="calender.jpg" alt="Select Date" name="popcal" width="23" height="25" border="0" align="absmiddle"></a> </a>        </tr>
		<tr>
          <TD class="style2">Parnet Activity </TD>
          <TD><select name=pActivity></select></TD>
        </tr>
		<tr>
...
%>
		...
		%>
            <option value="<%=p.getUser()%>"> <%=p.getName()+"_"+
...
e.printStackTrace();
      ...
      <p>
<input type='image' src="back.gif" alt="s" width="27" height="27" onClick="HR.jsp" name="I1" align="left"></DIV>&nbsp;<p><input type="text" style="visibility:hidden" value="newActivity" name="requestType">
	  </p>
...
<p>&nbsp;</p>
</DIV><!-- END OF JOIN ActionTrackingSystem EMAIL LIST -->
