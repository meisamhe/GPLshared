...
<DIV id=mainContentBorder align=center style="width: 718px; height: 503px">
<DIV id=mainnavLrg>
...
<TABLE style="WIDTH: 288px" cellSpacing=0 cellPadding=0 border=0>
  ...
  <TR vAlign=top>
    <TD id=leftContent><!-- ########### LEFT CONTENT ################# -->
      <span class="style2">Define New Employee </span>
      ...
      <TABLE cellSpacing=0 cellPadding=0 border=0>
        ...
        <TR>
          <TD class="style2">Family</TD>
          <TD><input type=text name=family width=40 >          </TD>
        </TR>
        <TR>
          <TD class="style2">User</TD>
          <TD><input type=text name=user width=40 >          </TD>
        </TR>
        <TR>
        ...
        <TR>
          <TD class="style2"><p>Department</p></TD>
          <TD><select name=department width=80>
              <jsp:useBean id="sampleMainServiceProxyid" scope="session" class="com.actionTracking.MainServiceProxy" />
                
              <%      com.actionTracking.Department[] getDepartments382mtemp = sampleMainServiceProxyid.getDepartments();
	if(getDepartments382mtemp != null){

       java.util.List listreturnp383= java.util.Arrays.asList(getDepartments382mtemp);
        %>
              <%
		for (int i=0; i<listreturnp383.size();i++){
			com.actionTracking.Department d=(com.actionTracking.Department)listreturnp383.get(i);
		%>
              <option value="<%=d.getName()+"_"+
			 d.getLocation()%>"><%=d.getName()+"_"+
      ...
      </DIV><input type="text" style="visibility:hidden" value="newEmployee" name="requestType">
...
<p align="left">
<form action="HR.jsp" >
<input type='image' src="back.gif" alt="s" width="24" height="24" onClick="HR.jsp">
