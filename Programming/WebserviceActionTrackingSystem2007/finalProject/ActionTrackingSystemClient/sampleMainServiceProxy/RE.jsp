...
<TABLE style="WIDTH: 308px" cellSpacing=0 cellPadding=0 border=0>
  ...
  <TR vAlign=top>
    <TD id=leftContent><!-- ########### LEFT CONTENT ################# -->
      <span class="style2">Replace Employee with another Employee </span>
...
e.printStackTrace();
      ...
      <p>
<input type='image' src="back.gif" alt="s" width="27" height="27" onClick="HR.jsp" name="I1" align="left"></DIV>&nbsp;<p><input type="text" style="visibility:hidden" value="replaceEmployee" name="requestType">
	  </p>
