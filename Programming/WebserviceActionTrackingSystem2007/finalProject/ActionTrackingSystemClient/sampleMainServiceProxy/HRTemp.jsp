...
<DIV id=topNavLrg>
<DIV id=bbLogo>
  <p><A href="http://www.brooksbrothers.com/" name=&amp;lid=Logo><IMG 
height=46 alt="ActionTrackingSystem" 
src="ActionTrackingSystem_files/logo.gif" width=256 
border=0></A></p>
  </DIV>
<DIV id=topNav>
...
border=0>
  ...
  <TR vAlign=top>
    ...
    <TD vAlign=top><IMG height=15 alt=Search 
      src="ActionTrackingSystem_files/topnav_lrg_search.gif" width=46 
      border=0></TD>
    <TD vAlign=top><INPUT class=search style="HEIGHT: 13px" 
      onfocus="this.value=''" name=q></TD>
    <TD vAlign=top><INPUT 
      onclick="if(document.SearchForm.q.value=='Enter item # or keyword')document.SearchForm.q.value=''" 
      type=image src="ActionTrackingSystem_files/topnav_lrg_go.gif" 
      name=Search></TD></FORM></TR></TBODY></TABLE></DIV></DIV>
<p><BR 
...
<DIV id=mainnavLrg>
<UL>
  <LI id=men><A href="http://www.brooksbrothers.com/men/landing_men.tem"></A>  </LI>
  <LI id=women><A 
  href="http://www.brooksbrothers.com/women/landing_women.tem"></A> </LI>
  <LI id=boys><A 
  href="http://www.brooksbrothers.com/boys/landing_boys.tem"></A> </LI>
  <LI id=countryclub><A 
  href="http://www.brooksbrothers.com/countryclub/default.tem"></A>  </LI>
  <LI id=blackfleece><A 
  href="http://www.brooksbrothers.com/blackfleece/default.tem"></A>  </LI>
  <LI id=holiday><A 
  href="http://www.brooksbrothers.com/holiday/holiday.tem"></A> </LI>
  <LI id=brooksbuys><A 
  href="http://www.brooksbrothers.com/brooksbuys/landing_brooksbuys.tem"></A> </LI>
  <LI id=giftcard><A 
  href="http://www.brooksbrothers.com/giftcard/landing_giftcard.tem"></A> </LI>
</UL></DIV>
<DIV 
style="PADDING-RIGHT: 0px; PADDING-LEFT: 0px; PADDING-BOTTOM: 0px; MARGIN: 0px; PADDING-TOP: 0px; HEIGHT: 5px ;width:400"><IMG 
style="BACKGROUND-COLOR: #d5ae65" height=5 alt="" 
src="ActionTrackingSystem_files/spacer.gif" width=354 border=0></DIV>
<DIV id=mainContent style="width: 412px; height: 400px">
<DIV id=breadCrumb style="MARGIN-TOP: 8px;width: 400px">
...
<DIV id=mainContentMiddleBorder style="width:400">
<DIV id=mainBody style="width:400">
<TABLE style="WIDTH: 668px" cellSpacing=0 cellPadding=0 border=0>
  <TBODY>
  <TR vAlign=top>
    <TD id=leftContent><!-- ########### LEFT CONTENT ################# --><IMG 
      ...
      action=FirstPage.jsp method=post><INPUT type=hidden name=logonUsername> 
      <INPUT type=hidden value=Logon name=Submit> <INPUT type=hidden 
      value="User with this name was not found." name=hMsgUserNotFound> <INPUT 
      type=hidden value="Login not valid." name=hMsgInvalidPassword> 
      ...
      <TABLE cellSpacing=0 cellPadding=0 border=0>
        ...
        <TR>
          ...
          <TD>
            <SCRIPT>
                            if (User==null || User=="") {  // if no cookie, set user value to NULL
                                document.write("<input type=text name=logonUsernameTemp MAXLENGTH=20 SIZE=10>");
                            }
                            else {  // if cookie exists, set logonUsername value to User
                                document.write("<input type=text name=logonUsernameTemp value=" + User + " MAXLENGTH=20 SIZE=10>");
                            }
                        </SCRIPT>          </TD></TR>
        <TR>
...
<DIV id=joinandFooter style="MARGIN-BOTTOM: 15px"><BR style="CLEAR: both; LINE-HEIGHT: 0; HEIGHT: 0px">
</DIV><!-- END OF JOIN ActionTrackingSystem EMAIL LIST --></DIV></DIV>
