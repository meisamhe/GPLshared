...
href="ActionTrackingSystem_files/regular-layout2.css" type=text/css 
rel=stylesheet><LINK href="ActionTrackingSystem_files/global2.css" 
...
<div> 
<DIV id=mainContentBorder align=center style="width: 813px; height: 528px">
<DIV id=mainnavLrg>
...
<DIV 
style="PADDING-RIGHT: 0px; PADDING-LEFT: 0px; PADDING-BOTTOM: 0px; MARGIN: 0px; PADDING-TOP: 0px; HEIGHT: 5px ;width:300">
	<IMG 
style="BACKGROUND-COLOR: #d5ae65" height=5 alt="" 
src="ActionTrackingSystem_files/spacer.gif" width=624 border=0></DIV>
<DIV id=mainContent style="width: 495px; height: 483px">
<DIV id=breadCrumb style="MARGIN-TOP: 8px;width: 300px">
...
<DIV id=mainContentMiddleBorder style="width:561px; height:407px">
<DIV id=mainBody style="width:489px; height:411px">
<!-- THIS PART IS FOR LINE-->
<TABLE style="WIDTH: 308px" cellSpacing=0 cellPadding=0 border=0>
  <TBODY>
  <TR vAlign=top>
    <TD id=leftContent><!-- ########### LEFT CONTENT ################# -->
      <span class="style2">Replace Manager with another Manager </span>
      <FORM name=departmentCreationForm
      action=HR.jsp method=post onSubmit="return checkPw(this)">
	  
      <DIV class=outlineBox id=signinBox 
      style="MARGIN-TOP: 15px; TEXT-ALIGN: center;width:468px; height:259px" >
      <TABLE width="274" height="217" border=0 cellPadding=0 cellSpacing=0>
        <TBODY>
        <TR>
        ...
        <TR>
          <TD class="style2"><p>OLDPerson</p></TD>
...
e.printStackTrace();
        ...
        <TR>
          <TD class="style2">newPersonName</TD>
          <TD>
          <input type=text name=name width=40 size="32" >     </TD></TR>
        <TR>
          <TD class="style2">newPersonFamily</TD>
          <TD><input type=text name=family width=40 size="32" >          </TD>
        </TR>
        <TR>
          <TD class="style2">User</TD>
          <TD><input type=text name=user width=40 size="32" >          </TD>
        </TR>
        <TR>
          <TD class="style2">Password</TD>
          <TD><input type=password name=password width=40 size="32" >          </TD>
        </TR>
        <TR>
          <TD class="style2"><p>ReWrit Password</p></TD>
          <TD><input type=password name=rePassword width=40 size="32" >          </TD>
        </TR>
        <TR>
          <TD><IMG height=1 alt=" " 
            src="ActionTrackingSystem_files/spacer(1).gif" width=1></TD>
      ...
      <p>
<input type='image' src="back.gif" alt="s" width="27" height="27" onClick="HR.jsp" name="I1" align="left"></DIV>&nbsp;<p><input type="text" style="visibility:hidden" value="replaceManager" name="requestType">
	  </p>
