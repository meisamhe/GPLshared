...
<TABLE style="WIDTH: 288px" cellSpacing=0 cellPadding=0 border=0>
  ...
  <TR vAlign=top>
    <TD id=leftContent><!-- ########### LEFT CONTENT ################# -->
      <span class="style2">Define New Department      </span>
      <FORM name=departmentCreationForm
      action=HR.jsp method=post>
      ...
      <TABLE cellSpacing=0 cellPadding=0 border=0>
        ...
        <TR>
          ...
          <TD><INPUT type=text name=location></TD></TR> <TR>
          <TD class="style2"><p>Upper Department</p>
            </TD>
          <TD><select name=upperDepartment width=80>
  ...
  <%      com.actionTracking.Department[] getDepartments382mtemp = sampleMainServiceProxyid.getDepartments();
	...
	<%	}
      ...
      </DIV><input type="text" style="visibility:hidden" value="newDepartment" name="requestType">
