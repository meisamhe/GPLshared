...
<span class="style10">
<% 	  int listLength=0;
        String user_157id=  request.getParameter("logonUsernameTemp");
        String user_157idTemp  = user_157id;
        String password_158id=  request.getParameter("logonPassword");
        String password_158idTemp  = password_158id;
        String type_159id=request.getParameter("type");
        String type_159idTemp  = type_159id;
//		out.print(user_157idTemp+" "+password_158idTemp+" "+type_159idTemp);
		boolean gotMethod = true;
		boolean sw=false;
		try{
		 int personAuthentication471mtemp = sampleMainServiceProxyid.personAuthentication(user_157idTemp,password_158idTemp,
		 type_159idTemp);       
		  String tempResultreturnp472 = org.eclipse.jst.ws.util.JspUtils.markup(String.valueOf(personAuthentication471mtemp));
		if (Integer.parseInt(tempResultreturnp472)==1){
				/*out.print("welcome "+user_157id+"!!");
				session.setAttribute("USER", user_157id);
				session.setAttribute("TYPE",type_159id);*/
				sw=true;
			}else{
				response.sendRedirect("ActionTrackingSystem.jsp");
		//		out.print("User Or Password was incorrect");	
		}
...
<DIV id=mainContentBorder align=center  style="width:938px; height:506px">
  <TABLE cellSpacing=0 cellPadding=0>
    <TBODY>
      ...
      <TD width="31" name="change Password"><a href="changePassword.jsp"><img src="changePassword.gif" width="32" height="37" border="0"></a></TD>
...
href="ActionTrackingSystem.jsp"><img src="logout.gif"></A> </TD>
  ...
  <DIV 
style="PADDING-RIGHT: 200px; PADDING-LEFT: 0px; PADDING-BOTTOM: 0px; MARGIN: 0px; PADDING-TOP: 0px; HEIGHT: 46px; width:1019px">
	<p align="left">
	<IMG 
style="BACKGROUND-COLOR: #d5ae65" height=6 alt="" 
src="ActionTrackingSystem_files/spacer.gif" width=819 border=0></DIV>
<DIV id=mainContent style="width:922px; height:418px">
<DIV id=breadCrumb style="width:1000" ></DIV>
<DIV id=mainContentMiddleBorder style="width:871px; height:388px">
	<DIV id=mainBody>
<%try{%>
      ...
      id=rightContent><!-- ########### RIGHT CONTENT ################# -->
      				<DIV style="MARGIN: 15px 0px">
						<p><%out.print("welcome "+user_157id+"!!");
				session.setAttribute("USER", user_157id);
				session.setAttribute("TYPE",type_159id);%>
		</p>
		  <% if (sw==true){%>
						<p><span class="affHeadline style7">Activities That are Not Completed Until Today and passed Deadline:</span>
						</p></DIV>
...
<p></p>
<DIV id=joinandFooter style="width:1000">
	<BR style="CLEAR: both; LINE-HEIGHT: 0; HEIGHT: 0px">
