...
<table width="430">
    <tbody>
      <tr>
        <td width="39"><a href="changePasswordFINANCE.jsp"><img src="changePassword.gif" width="32" height="35" border="0"></a></td>
...
<TABLE style="WIDTH: 288px" cellSpacing=0 cellPadding=0 border=0>
  ...
  <TR vAlign=top>
    <TD id=leftContent><!-- ########### LEFT CONTENT ################# -->
      ...
      action=finance.jsp method=post>
      ...
      <TABLE cellSpacing=0 cellPadding=0 border=0>
        ...
        <TR>
          <TD class="style2">Current-Resource</TD>
          <TD><select name=resource width=80>
...
e.printStackTrace();
        ...
        <TR>
          <TD class="style2">Updated Inhand </TD>
          <TD><INPUT type=text name=inHand></TD>
        </TR>
        <TR>
          <TD><IMG height=1 alt=" " 
            src="ActionTrackingSystem_files/spacer(1).gif" width=1></TD>
      ...
      </DIV><input type="text" style="visibility:hidden" value="updateResource" name="requestType">
