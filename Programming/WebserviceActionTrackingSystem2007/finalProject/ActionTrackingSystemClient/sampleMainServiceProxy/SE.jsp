...
href="ActionTrackingSystem.jsp"><img src="logout.gif"></A> </TD>
  ...
  <DIV 
style="PADDING-RIGHT: 200px; PADDING-LEFT: 0px; PADDING-BOTTOM: 0px; MARGIN: 0px; PADDING-TOP: 0px; HEIGHT: 5px"><IMG 
style="BACKGROUND-COLOR: #d5ae65" height=5 alt="" 
src="ActionTrackingSystem_files/spacer.gif" width=1000 border=0><p>&nbsp;</p>
	<p></DIV>
  ...
  <TR vAlign=top>
    <TD 
      ...
      <DIV style="MARGIN: 15px 0px">
        <p>	</p>
		  <% if (true){%>
		<p><span class="affHeadline style7">Activities That are Not Completed 
		Until Today and passed Deadline:</span> </p>
      </DIV>
...
java.lang.String typename292 = activity.getName();
      ...
      action=submitActivity.jsp method=post> 
       <input type=text style="visibility:hidden" size=1 value="<%=i%>" name="form">
              <%= tempResultname292 %>  
                <%
}%>
            </p></td>
...
%>			
				<select name=assignedTo<%=i%>>
         		   <option value="<%=p.getName()+"_"+p.getFamily()+"("+p.getDepartment()+")"%>" width="53" size="2"><%=p.getName()+"_"+p.getFamily()+"("+p.getDepartment()+")"%></option><%
				   	String type_130id= (String) session.getAttribute("TYPE");
...
%>
  <option value="<%=tempPerson.getName()+"_"+tempPerson.getFamily()+"("+tempPerson.getDepartment()+")"%>"><%=tempPerson.getName()+"_"+tempPerson.getFamily()+"("+tempPerson.getDepartment()+")"%></option>
<%
}
}
					%>
            ...
            <td  >
			  ...
			  <input name="button" type="button" title="applyChange" value="change">
			  </form>
			</td>
        ...
        %>
                <div align="center">
                  <form method="post" action="Description.jsp" target="_blank">
                    ...
                    <input type="image" name=I1 width="36" height="24"  src="discription.gif" border="0" >
                  </form>
                </div>
              <%}%>
                <div id="div<%=i%>"> </div></td>
            <td  > <div align="center">
              <input type="image" name=I2 width="26" height="24"  src="report.jpg" border="0" >
            </div></td>
            <td  > <div align="center">
