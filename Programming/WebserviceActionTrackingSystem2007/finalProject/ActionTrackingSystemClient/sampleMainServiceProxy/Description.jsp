...
<TABLE style="WIDTH: 287px" cellSpacing=0 cellPadding=0 border=0>
  ...
  <TR vAlign=top>
    <TD id=leftContent width="266"><!-- ########### LEFT CONTENT ################# -->
      <span class="sectionCold">Change Description: </span>
      <FORM name=LoginForm  
      action=Description.jsp method=post>
	...
	<%	try{
	  ...
	  if (requestType!=null){
	   if (requestType.equals("changeDescription")){
		  String  activityIdStr=request.getParameter("activityID");
		  long activityID = Long.parseLong(activityIdStr);
		  String person=request.getParameter("person");
		  String user=person.substring(0, person.indexOf('_'));
		  String type=person.substring(person.indexOf('_')+1,person.length());
	//	  	  out.print("check");
		  String activityID_48id=  activityIdStr;
        long activityID_48idTemp  = Long.parseLong(activityID_48id);
        String personType_49id=  type;
        java.lang.String personType_49idTemp  = personType_49id;
        String description_50id=  request.getParameter("description");
        java.lang.String description_50idTemp  = description_50id;
        String personUser_51id=  user;
        java.lang.String personUser_51idTemp  = personUser_51id;
        java.lang.String preciseDescription144mtemp = sampleMainServiceProxyid.preciseDescription(activityID_48idTemp,personType_49idTemp,description_50idTemp,personUser_51idTemp);

if(preciseDescription144mtemp == null){
%>
<%=preciseDescription144mtemp %>
<%
}else{
        String tempResultreturnp145 = org.eclipse.jst.ws.util.JspUtils.markup(String.valueOf(preciseDescription144mtemp));
        %>
	...
	%>	
     ...
     <TABLE width="347" height="217" border=0 cellPadding=0 cellSpacing=0>
        <TBODY>
          ...
          <TR>
            <TD class="style2">oldDescription</TD>
            <TD><%=request.getParameter("description")%>            </TD>
          </TR>
          <tr>
            <TD colspan="2"><p class="style2">NewDescription:
			 </p>
                <p>
          ...
          <tr>
            ...
            src="ActionTrackingSystem_files/spacer(1).gif" width=1>
              <input type=text name=requestType size=1 style="visibility:hidden" value="changeDescription">
