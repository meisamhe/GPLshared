...
<TABLE style="WIDTH: 308px" cellSpacing=0 cellPadding=0 border=0>
  ...
  <TR vAlign=top>
    <TD id=leftContent><!-- ########### LEFT CONTENT ################# -->
      <span class="style2">Delete Employee      </span>
      ...
      <TABLE width="274" height="217" border=0 cellPadding=0 cellSpacing=0>
        ...
        <TR>
          <TD colspan="2" class="style2"><p>Please Choose employee that you want Delete : </p></TD>
          </TR>
        <TR>
          <TD colspan="2"><select name=oldEmployee width=80>
...
e.printStackTrace();
      ...
      <p>
<input type='image' src="back.gif" alt="s" width="27" height="27" onClick="HR.jsp" name="I1" align="left"></DIV>&nbsp;<p><input type="text" style="visibility:hidden" value="deleteEmployee" name="requestType">
	  </p>
