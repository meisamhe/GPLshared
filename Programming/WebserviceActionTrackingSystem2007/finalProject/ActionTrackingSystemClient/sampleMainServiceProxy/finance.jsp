...
<% if (session.getAttribute("TYPE") == null )
	...
	else if (((String)session.getAttribute("TYPE")).compareTo("finance")!=0)
	response.sendRedirect("ActionTrackingSystem.jsp");
	%>
<A name=top></A>
...
<DIV id=mainContentBorder align=center style="width: 450px; height: 287px">
<span class="sectionHot style6"><table width="430"><tbody><tr><td width="39"><a href="changePasswordFINANCE.jsp"><img src="changePassword.gif" width="32" height="35" border="0"></a></td>
...
<DIV id=mainContent style="width: 372px; height: 209px">
  ...
  <TR vAlign=top>
    <TD id=leftContent><!-- ########### LEFT CONTENT ################# -->
      ...
      <TABLE cellSpacing=0 cellPadding=0 border=0>
        ...
        <TR>
          <TD class="style3"><a href="DR.jsp">Define Resource  </a></TD>
          <TD>&nbsp;</TD>
        </TR>
        <TR>
          <TD class="style2"><a href="CR.jsp" class="style5">Change Resource </a></TD>
          <TD>&nbsp;</TD>
        </TR>
        </TBODY></TABLE>
...
try{
if (requestType!=null){
if (requestType.equals("newResource")){
		 String name_71id=  request.getParameter("name");
        java.lang.String name_71idTemp  = name_71id;
        String place_72id=  request.getParameter("place");
        java.lang.String place_72idTemp  = place_72id;
        String inHand_73id=  request.getParameter("inHand");
        int inHand_73idTemp  = Integer.parseInt(inHand_73id);
        java.lang.String defineResourceForOrganization202mtemp = sampleMainServiceProxyid.defineResourceForOrganization(name_71idTemp,place_72idTemp,inHand_73idTemp);
if(defineResourceForOrganization202mtemp == null){
%>
<%=defineResourceForOrganization202mtemp %>
<%
}else{
        String tempResultreturnp203 = org.eclipse.jst.ws.util.JspUtils.markup(String.valueOf(defineResourceForOrganization202mtemp));
        %>
        <%= tempResultreturnp203 %>
        <%
}
		}else	if (requestType.equals("updateResource")){
		String resource=(String)request.getParameter("resource");
		 String name_71id=  resource.substring(0, resource.indexOf('_'));
        java.lang.String name_71idTemp  = name_71id;
        String place_72id=  resource.substring(resource.indexOf('_')+1,resource.length());
        java.lang.String place_72idTemp  = place_72id;
		String inHand_73id=(String)request.getParameter("inHand");
        int inHand_73idTemp  = Integer.parseInt(inHand_73id);
        java.lang.String defineResourceForOrganization202mtemp = sampleMainServiceProxyid.changeResourceQuantityOfOrganization(name_71idTemp,place_72idTemp,inHand_73idTemp);
if(defineResourceForOrganization202mtemp == null){
%>
<%=defineResourceForOrganization202mtemp %>
<%
