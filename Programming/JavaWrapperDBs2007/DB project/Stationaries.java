...
public class Stationaries {
	 ...
	 */
	protected int insert(String name,String manufacturedBY,
			double price,double quantity,String description){
		String sql="INSERT INTO STATIONARIES VALUES(NULL,'"+name+"','"+manufacturedBY;
	...
	protected int update(int id,String setClause){
		...
		String sql="UPDATE STATIONARIES SET "+setClause+ " WHERE (ID="+id+")";
		int test=msc.runSqlDDL(sql, mySql);
		return test;
	}
	/**
