 ...
 */
public class MatrixMultiplicationRmiClientMIDlet extends MIDlet {
...
//                       service = (TheService) reg.lookup("service");
                         MatrixMultiplicationClientThread ct = new MatrixMultiplicationClientThread(this,currentMIDlet,nodeName,preferredNetwork,service) ;
                         ct.start();
//                        try {
