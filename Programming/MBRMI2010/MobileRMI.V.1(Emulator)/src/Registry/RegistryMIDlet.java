...
//                        service = new TheServiceImpl(nodeName, "checkService",preferredNetwork,thisMIDlet);
//                        System.out.println("RMISERVER: Created service\n");
//                        this.append("RMISERVER: Created service\n");
...
//                           this.append("RMISERVER: Bound service") ;
//                        } catch (Exception te) {
//                            te.printStackTrace();  //To change body of catch statement use File | Settings | File Templates.
//                            this.append(te.getMessage());
//                        }
                    // server initiation Code
                    //Code for RegistryUse
                    registry = new ServerRegistry(nodeName,this, thisMIDlet);
