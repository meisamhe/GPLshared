...
public class RegistryClient extends MIDlet implements FrameworkListener{
...
//		sendGui = new SendGui();
    ...
    public void notifyAboutFoundNode(String nodeAddress, String remoteNodeName){
            ...
            framework.sendTextPackage(nodeAddress,"Service1"); // I just send the service and I should recive assigned port
...
//                         DataOutputStreamWrapper dow= new DataOutputStreamWrapper("registry.txt");
                         for (int i=0; i<3; i++){
//                             pdb.insert(new RegistryEntity("service"+i,Integer.toString(40*i)));
//                             dow.writeUTF("Service"+i);
//                             dow.writeInt(40*i);
                         }
//                        dow.close();
//                        DataInputStreamWrapper diw=new DataInputStreamWrapper("registry.txt");
//                        RegistryEntity e= (RegistryEntity) pdb.getEntity(1);
//                        pdb.closeDB();
//                        append(e.name);
