 ...
 */
public class MatrixMultiplicationServerMIDlet extends MIDlet {
    ...
    private MatrixMultiplicationImpl service;
...
//                        NinjaRemoteStub nsk=(NinjaRemoteStub) skelclass.newInstance();
                        service = new MatrixMultiplicationImpl(nodeName, "checkService",preferredNetwork,thisMIDlet);
                        ...
                        registry.rebind("MatrixMultiplication",service);
