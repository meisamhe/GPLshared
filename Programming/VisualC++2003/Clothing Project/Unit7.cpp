...
//---------------------------------------------------------------------------
void __fastcall TaddForm::backBtnClick(TObject *Sender)
{
        anbarForm->Show();
        addForm->Hide();
}
...
void __fastcall TaddForm::colorComboSelect(TObject *Sender)
{
...
void __fastcall TaddForm::seasonRadioClick(TObject *Sender)
{
...
void __fastcall TaddForm::casualRadioClick(TObject *Sender)
{
        if (seasonRadio->ItemIndex==0)
        {
                if (casualRadio->ItemIndex==0)
...
void __fastcall TaddForm::registerBtnClick(TObject *Sender)
{
