...
%     etacsp(j)   =  1/gamrnd(wa1,1/wv12);
    ...
    %---------------------------------------------------------------
     ...
     j=1; % for version
    S1   =  (((CSq0'*CSq0)/etacsq(j))+CS1Inv)\speye(size((((CSq0'*CSq0)/etacsq(j))+CS1Inv))); %inv(((CSL'*CSL)/eta(j))+CS0Inv); 
    b1   =  S1*(((CSq0'*btempaddon(j,:)')/etacsq(j))+CS1Inv*cs1); %btempp(j,1)
    ...
    j=2; % for version
    S1   =  (((CSq1'*CSq1)/etacsq(j))+CS1Inv)\speye(size((((CSq1'*CSq1)/etacsq(j))+CS1Inv))); %inv(((CSL'*CSL)/eta(j))+CS0Inv); 
    b1   =  S1*(((CSq1'*btempaddon(j,:)')/etacsq(j))+CS1Inv*cs1); %btempp(j,1)
    ...
    j=3; % for version
    S1   =  (((CSq2'*CSq2)/etacsq(j))+CS1Inv)\speye(size((((CSq2'*CSq2)/etacsq(j))+CS1Inv))); %inv(((CSL'*CSL)/eta(j))+CS0Inv); 
    b1   =  S1*(((CSq2'*btempaddon(j,:)')/etacsq(j))+CS1Inv*cs1); %btempp(j,1)
...
%     etacsq(j)   =  1/gamrnd(wa1,1/wv12);   
    ...
    S1   =  (((CSq4'*CSq4)/etacsq(j))+CS1Inv)\speye(size((((CSq4'*CSq4)/etacsq(j))+CS1Inv))); %inv(((CSL'*CSL)/eta(j))+CS0Inv); 
    b1   =  S1*(((CSq4'*btempaddon(j,:)')/etacsq(j))+CS1Inv*cs1); %btempp(j,1)
