...
m0LL{j}  = cell([1 n]);
mLL{j}   = cell([1 n]);
gammaaddonLL{j} =  cell([1 n]);
deltaaddonLL{j} = cell([1 n]);
alphaMaddonLL{j} = cell([1 n]);
betaaddonLL{j} = cell([1 n]);
...
ttind1addonLL = ttind1addonLL/((ndraw-ndraw0)/jumps);
