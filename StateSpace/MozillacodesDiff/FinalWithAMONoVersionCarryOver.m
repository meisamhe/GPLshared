...
parfor i=1:n;
  ...
  %  T(1,i)=min(min(checksize(num(:,15)),checksize(num(:,1))),checksize(num(:,8)));
   ...
   % beta = 0.0001*rand(1,1);
    [xaddon{i},y{i},uT{i},ol{i},stv{i},ver{i},wkend{i},status{i},T(i),stol{i},stavg{i}] = readOLRTNoCarryOver(numaddon,T(i),alphabetaapram{i},p,tt1p,tt0p,pT,scale,pusg,ffxvrsn,numCatOL,numCatVAR,i); %int{i},piai{i}
