...
function [m,C,m0,C0,tt1,tt0] = BEKFPMCompetitor(y,F,p,m0,C0,v,w,GT,uT,GTtemp,piaitemp,n,tt2,unblncPnl,yc) %,b1,b2,alpha
...
%         t
%      end;
     g      =   Jmcm(d,mt,yc,t); %alpha,
     r      =   g*Ct*g' + w;                        % variance of prior at t-1

    a      =   fmcm(d,mt,yc,t) + uT(t,:); %alpha,
...
%      end;
    ...
    g    =   Jmcm(d,m(:,t),yc,t); %alpha, 
    a    =   fmcm(d,m(:,t),yc,t)+ uT(t+1,:); %alpha,
