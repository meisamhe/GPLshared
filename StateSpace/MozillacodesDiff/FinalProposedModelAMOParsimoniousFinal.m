...
for  j=1:n;
    ...
    ttind1addonLL= addonttindepbuilderOLSTpq(tt0LL{j},tt1LL{j},T(j),xaddon{j},ttr1LL',ttind1pLL(1),pT,mLL{j},m0LL{j},phetrgn{j},qhetrgn{j}) ; % drop last value
